 ...
 * util
 *
 * @Author Moxiao 2019-07-01 13:48
 * @Use HTTP CLIENT
 */
public class HttpClientUtil {
    ...
    private static void setPostContentJson(HttpPost httpPost, String contentJson) {
        StringEntity stringEntity = new StringEntity(contentJson, "UTF-8");
        stringEntity.setContentType(ContentType.APPLICATION_JSON.getMimeType());
        httpPost.setEntity(new StringEntity(contentJson, "UTF-8"));
    }
    ...
    public static String post(String url, Map<String, Object> params, Map<String, String> headerParams) throws IOException {
        return post(url, params, null, headerParams);
    }

    public static String postForMediaJSON(String url, String content) throws IOException {
        Map<String, String> headerParams = new HashMap<>();
        headerParams.put("Content-Type", "application/json");
        return post(url, null, content, headerParams);
    }
     ...
     * @throws IOException
     */
    public static String post(String url, Map<String, Object> params, String contentJson, Map<String, String> headerParams) throws IOException {
        ...
        /*check media json*/
        if (hasHeaderJson(httpPost.getAllHeaders())) {
            setPostContentJson(httpPost, contentJson);
        } else {
    ...
    private static Boolean hasHeaderJson(Header[] headers) {
        if (null == headers) {
            return false;
        }
        for (Header header : headers) {
            if (header.getName().equals("Content-Type") && header.getValue().equals(ContentType.APPLICATION_JSON.getMimeType())) {
                return true;
            }
        }
        return false;
